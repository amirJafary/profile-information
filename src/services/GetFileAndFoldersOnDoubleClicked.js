...
const GetFileAndFoldersOnDoubleClicked =(callback,parentId)=>{
    let url ='http://172.17.17.101:8088/api/en/FileManager/FolderManagement/GetFileAndFolders?&parentId='+parentId+''
...
export {GetFileAndFoldersOnDoubleClicked};