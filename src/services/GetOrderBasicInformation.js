...
const GetOrderBasicInformation =(callback,id)=>{
    let url = 'http://172.17.17.101:8088/api/en/Order/UserOrder/GetOrderBasicInfo?&orderId='+id+''
...
export {GetOrderBasicInformation};